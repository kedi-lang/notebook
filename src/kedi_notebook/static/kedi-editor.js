...
function defineKediThemes(monaco) {
  monaco.editor.defineTheme("kedi-dark", {
    ...
    colors: {
      ...
      "editor.foreground": "#E2E5E8",
      "editorLineNumber.foreground": "#737B85",
      "editorLineNumber.activeForeground": "#BAC2CB",
      "editorCursor.foreground": "#80CCA4",
      "editor.lineHighlightBackground": "#1D2125",
      "editor.selectionBackground": "#304B42",
      "editor.inactiveSelectionBackground": "#2C343A",
      "editorIndentGuide.background1": "#282E34",
      "editorIndentGuide.activeBackground1": "#48545D",
      "editorBracketMatch.background": "#2C3833",
      "editorBracketMatch.border": "#80CCA4",
    },
  });
}
